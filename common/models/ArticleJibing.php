...
/**
 * This is the model class for table "sea_article_jibing".
 *
 * @property string $id
 * @property int $article_cate_id 分类ID
 * @property string $url 采集url
 * @property string $url_create_time
 ...
 * @property string $images_domain
 * @property int $is_deal_images
 */
class ArticleJibing extends \common\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['url', 'notice_type', 'article_title', 'cover_img_url', 'article_author', 'summary', 'source_name', 'seo_title', 'seo_keywords', 'seo_description', 'images_domain'], 'string', 'max' => 255],
        ];
    }
