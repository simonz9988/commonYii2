...
namespace backend\extensions\alipay_trade;

use Yii;
use backend\extensions\alipay_trade\service\AlipayTradeService;
use backend\extensions\alipay_trade\buildermodel\AlipayTradeRefundContentBuilder;
use backend\extensions\alipay_trade\buildermodel\AlipayTradeFastpayRefundQueryContentBuilder;
use backend\extensions\alipay_trade\buildermodel\AlipayTradeQueryContentBuilder;
...
class alipayTrade
{
    ...
    public function setConfig($config_param)
    {
        $this->config_params = array (
            ...
            // 应用ID,您的APPID。
            'app_id' => $config_param['app_id'],
        
            // 商户私钥
            'merchant_private_key' => $config_param['merchant_private_key'],
            ...
            // 支付宝公钥
            'alipay_public_key' => $config_param['alipay_public_key'],
        );
    }
    ...
    public function refund($trade_no, $refund_amount, $refund_trade_no, $refund_reason = '', $out_trade_no)
    {
        ...
        if(!$response || $response['code'] != '10000'){
            ...
            Yii::$app->CommonLogger->logError("支付宝退款返回失败：".json_encode($error_info,JSON_UNESCAPED_UNICODE));
        }
