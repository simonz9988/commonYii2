<?php
namespace backend\extensions\globalapp_alipay_trade\aop;

require_once 'AopEncrypt.php';
use backend\extensions\globalapp_alipay_trade\aop\SignData;
use backend\extensions\globalapp_alipay_trade\aop\EncryptParseItem;
...
class AopClient {
    ...
    */
    ...
    public function execute($request, $authToken = null, $appInfoAuthtoken = null) {
        ...
        if(!$res_data || $res_data['alipay_trade_refund_response']['code'] != '10000'){
            return $respObject;
        }
