...
/**
 * @brief 中文分词工具，从老框架迁移过来，删除了部分逻辑，保留核心功能
 * @author joker.huang
 * @date   2017-05-02 17:19:00
 */
...
class Scws {
    ...
    /**
     * 实例化中文分词类
     * @return ScwsClient|null
     */
    private function createInstance() {
        if ($this->instance == null) {
            $this->instance = new ScwsClient();
        }
    ...
    /**
     * 执行分词任务
     * @param string $words 待分词字符串
     * @return array
     */
    public function run($words) {
        $instance = $this->createInstance();

        return $instance->run($words);
    }
}
 ...
 * @version 0.1
 */
class ScwsClient implements wordsPart_inter
{
    /**
     * @brief 获取提交按钮
     * @return string
