    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/sunny-device-category/info-report" method="get">
                    ...
                    <div class="form-group">
                        <label>国家：</label>
                        <input name="country" value="<?=$searchArr?$searchArr['country']:''?>" class="input-sm  form-control" type="text">
                    </div>

                    <div class="form-group">
                        <label>省：</label>
                        <input name="province" value="<?=$searchArr?$searchArr['province']:''?>" class="input-sm  form-control" type="text">
                    </div>

                    <div class="form-group">
                        <label>市：</label>
                        <input name="city" value="<?=$searchArr?$searchArr['city']:''?>" class="input-sm  form-control" type="text">
                    </div>

                    <div class="form-group">
                        <label>区：</label>
                        <input name="district" value="<?=$searchArr?$searchArr['district']:''?>" class="input-sm  form-control" type="text">
                    </div>
                    ...
                    <?php if($list):?>
                        <?php foreach($list as $v):?>
                            <tr>
                                ...
                                <td><?=$v['device_info']['longitude']?></td>
                                <td><?=$v['device_info']['latitude']?></td>
                                <td><?=$v['status_record']?($v['status_record']['switch_status']=="Y"?"ON":"OFF"):''?></td>
                                <td><?=$v['status_record']?$v['status_record']['battery_volume']:""?></td>
                                <td><?=$v['country'].','.$v['province'].','.$v['city'].','.$v['district']?></td>
