    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/api-key/save" method="post">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right">对冲比例</label>

                    <div class="col-sm-5">
                        <input value="<?=$info?$info['qiangpin_percent']:''?>"name="qiangpin_percent" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                        <label class="col-sm-12 form-control-static reg_tip">
                        </label>
