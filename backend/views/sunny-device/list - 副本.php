                    ...
                    <?php if($list):?>
                        <?php foreach($list as $v):?>
                            <tr>
                                ...
                                <td class="td-info td-info-brightness"><?=$v['brightness']?>路灯亮度</td>
                                <td class="td-info td-info-battery_voltage">蓄电池电压(V)<?=$v['status_info']?$v['status_info']['battery_voltage']:''?></td>
                                <td class="td-info td-info-battery_charging_current">蓄电池充电电流(A)<?=$v['status_info']?$v['status_info']['battery_charging_current']:''?></td>
                                <td class="td-info td-info-charging_current">蓄电池功率(W)<?=$v['status_info']?$v['status_info']['charging_current']*$v['status_info']['load_dc_power']:''?></td>
                                <td class="td-info td-info-charge_status">蓄电池充电状态<?=$v['status_info']?$v['status_info']['charge_status']:''?></td>
                                <td class="td-info td-info-battery_volume">蓄电池剩余电量<?=$v['status_info']?$v['status_info']['battery_volume']:''?></td>
                                <td class="td-info td-info-battery_temperature">蓄电池温度(℃)<?=$v['status_info']?$v['status_info']['battery_temperature']:''?></td>
                                <td class="td-info td-info-battery_panel_charging_voltage">太阳能板电压(V)<?=$v['status_info']?$v['status_info']['battery_panel_charging_voltage']:''?></td>
                                <td class="td-info td-info-battery_panel_charging_current">太阳能板电流(A)<?=$v['status_info']?$v['status_info']['battery_panel_charging_current']:''?></td>
                                <td class="td-info td-info-charging_power">太阳能板功率(W)<?=$v['status_info']?$v['status_info']['charging_power']:''?></td>
                                <td class="td-info td-info-battery_charging_current">蓄电池电流(A)<?=$v['status_info']?$v['status_info']['battery_charging_current']:''?></td>
                                <td class="td-info td-info-load_dc_power">路灯电压(V)<?=$v['status_info']?$v['status_info']['load_dc_power']:''?></td>
                                <td class="td-info td-info-charging_current">路灯电流(A)<?=$v['status_info']?$v['status_info']['charging_current']:''?></td>
                                <td class="td-info td-info-cumulative_charge">路灯功率(W)<?=$v['status_info']?$v['status_info']['cumulative_charge']:''?></td>
                                <td class="td-info td-info-light_temp">灯头温度(℃)未知</td>
                                <td class="td-info td-info-fault_list">故障信息<?=$v['fault_list']?></td>
                                <td class="td-info td-info-switch_status">供电状态<?=$v['status_info']?($v['status_info']['switch_status']=="Y"?'开':'关'):''?></td>

                                <td class="td-info td-info-bat_min_volt_today"><?=$v['today_info']?$v['today_info']['bat_min_volt_today']:''?>当天最低电压(V)</td>
                                <td class="td-info td-info-bat_max_volt_today"><?=$v['today_info']?$v['today_info']['bat_max_volt_today']:''?>当天最高电压(V)</td>
                                <td class="td-info td-info-bat_charge_ah_today"><?=$v['today_info']?$v['today_info']['bat_charge_ah_today']:''?>当天充电最大电流(A)</td>
                                <td class="td-info td-info-bat_discharge_ah_today"><?=$v['today_info']?$v['today_info']['bat_discharge_ah_today']:''?>当天放电最大电流(A)</td>
                                <td class="td-info td-info-bat_max_charge_power_today"><?=$v['today_info']?$v['today_info']['bat_max_charge_power_today']:''?>当天充电最大功率(W)</td>
                                <td class="td-info td-info-bat_max_discharge_power_today"><?=$v['today_info']?$v['today_info']['bat_max_discharge_power_today']:''?>当天放电最大功率(W)</td>
                                <td class="td-info td-info-bat_charge_ah_today"><?=$v['today_info']?$v['today_info']['bat_charge_ah_today']:''?>当天充电安时数(AH)</td>
                                <td class="td-info td-info-bat_discharge_ah_today"><?=$v['today_info']?$v['today_info']['bat_discharge_ah_today']:''?>当天放电安时数(AH)</td>
                                <td class="td-info td-info-generat_energy_today"><?=$v['today_info']?$v['today_info']['generat_energy_today']:''?>当天发电量(Wh)</td>
                                <td class="td-info td-info-used_energy_today"><?=$v['today_info']?$v['today_info']['used_energy_today']:''?>当天用电量(Wh)</td>
                                <td class="td-info td-info-bat_highest_temper"><?=$v['today_info']?$v['today_info']['bat_highest_temper']:''?>当天蓄电池最高温度(℃)</td>
                                <td class="td-info td-info-bat_lowest_temper"><?=$v['today_info']?$v['today_info']['bat_lowest_temper']:''?>当天蓄电池最低温度(℃)</td>
                                <td class="td-info td-info-load_total_work_time"><?=$v['total_info']?$v['total_info']['load_total_work_time']:''?>负载总工作（累计亮灯）</td>
                                <td class="td-info td-info-led_sensor_off_time"><?=$v['today_info']?$v['today_info']['led_sensor_off_time']:''?>当天亮灯时间</td>
                                <td class="td-info td-info-bat_charge_time"><?=$v['today_info']?$v['today_info']['bat_charge_time']:''?>当天充电时间</td>
                                <td class="td-info td-info-led_light_on_index"><?=$v['today_info']?$v['today_info']['led_light_on_index']:''?>亮灯指数</td>
                                <td class="td-info td-info-power_save_index"><?=$v['today_info']?$v['today_info']['power_save_index']:''?>能耗指数</td>
                                <td class="td-info td-info-sys_health_index"><?=$v['today_info']?$v['today_info']['sys_health_index']:''?>健康指数</td>
                                <td class="td-info td-info-work_days_total"><?=$v['total_info']?$v['total_info']['work_days_total']:''?>运行天数</td>
                                <td class="td-info td-info-bat_over_discharge_time"><?=$v['total_info']?$v['total_info']['bat_over_discharge_time']:''?>蓄电池总过放次数</td>
                                <td class="td-info td-info-bat_over_charge_time"><?=$v['total_info']?$v['total_info']['bat_over_charge_time']:''?>蓄电池总充满次数</td>
                                <td class="td-info td-info-bat_charge_an_total"><?=$v['total_info']?$v['total_info']['bat_charge_an_total']:''?>蓄电池总充电安时数(AH)</td>
                                <td class="td-info td-info-bat_discharge_an_total"><?=$v['total_info']?$v['total_info']['bat_discharge_an_total']:''?>蓄电池总放电安时数(AH)	</td>
                                <td class="td-info td-info-generat_energy_total"><?=$v['total_info']?$v['total_info']['generat_energy_total']:''?>累计发电量(kWh)</td>
                                <td class="td-info td-info-used_energy_total"><?=$v['total_info']?$v['total_info']['used_energy_total']:''?>累计用电量(kWh)</td>
                                <td class="td-info td-info-load_total_work_time"><?=$v['total_info']?$v['total_info']['load_total_work_time']:''?>负载总工作时间</td>
