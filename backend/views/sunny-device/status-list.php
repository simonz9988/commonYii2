    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/sunny-device/status-list" method="get">

                    <input type="hidden" value="<?=$not_group_by?>" name="not_group_by">
                    ...
                    <div class="form-group" style="display: none;">
                        <label>设备ID：</label>
                        <input name="device_id" value="<?=$searchArr?$searchArr['device_id']:''?>" class="input-sm  form-control" type="text">
                    </div>
                    ...
                    <tbody>
                        <?php if($list):?>
                            ...
                            <tr>
                                ...
                                <td  style="display: none ;"><?=$v['charging_power']?></td>
                                <td><?=$v['cumulative_charge']?></td>
                                <td><?=$v['load_status']?></td>
                                <td><?=$v['switch_status']?></td>
                                <td><?=$v['brightness']?></td>
                                <td><?=$v['create_time']?></td>
