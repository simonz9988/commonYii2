...
<div class="page-content">
    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/storage-product-total/save" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input readonly="true" value="<?=$from_date?>"  name="from_date" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="type" class="input-sm  col-xs-12 col-sm-6" readonly="true" >
                            <?php foreach($type_list as $k=>$v):?>
                                <option value="<?=$v['id']?>" <?=$type_id==$v['id']?'selected="selected"':''?>><?=$v['detail']?></option>
                            <?php endforeach ;?>
                        </select>
                    </div>
                    <div class="col-sm-4">
