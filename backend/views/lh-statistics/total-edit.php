...
<div class="page-content">
    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/lh-process/total-save" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input value="<?=$year?>.<?=$month?>" readonly name="name" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
