    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/all-okex-order/list" method="get">

                    <div class="form-group">
                        <label>用户编号：</label>
                        <input name="local_admin_user_id" value="<?=$searchArr?$searchArr['local_admin_user_id']:''?>" class="input-sm  form-control" type="text">
                    </div>
