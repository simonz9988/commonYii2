    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/language/save" method="post">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right">缩写(唯一)</label>

                    <div class="col-sm-5">
                        <input value="<?=$info?$info['short']:''?>"name="short" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                        <label class="col-sm-12 form-control-static reg_tip">
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="is_default" class="input-sm  col-xs-12 col-sm-6">
                            <option value="Y" <?=$info&&$info['is_default']=='Y'?'selected="selected"':''?>>是</option>
                            <option value="N"  <?=$info&&$info['is_default']=='N'?'selected="selected"':''?>>否</option>
                        </select>
                    </div>
                </div>
