...
<div class="breadcrumbs" id="breadcrumbs">
    <div class="row">
        ...
        <div class="col-md-4 text-right" >
            <a href="<?=url('/article/edit')?>" class="btn btn-primary btn-sm no-border"><i class="ace-icon glyphicon glyphicon-plus"></i> 新增</a>
        </div>
    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/article/index" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <select name="cate_id">
                            ...
                            <?php foreach($cate_list as $k=>$v):?>
                                <option value="<?=$k?>" <?=$searchArr && $searchArr['cate_id']!= '' && $searchArr['cate_id'] ==$k?'selected="selected"':''?>><?=$v['name']?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <tbody>
                        <?php if($list):?>
                            ...
                            <tr>
                                ...
                                <td><?=$v['create_time']?></td>
                                <td>
                                    <a class="btn btn-primary btn-xs" href="<?=url('/article/edit?id='.$v['id'])?>"> <i class="ace-icon fa fa-edit bigger-100"></i> 修改</a>
                                    <a class="btn btn-xs btn-danger cus-btn-del" href="javascript:void(0);" onclick="delModel('/article/del?id=<?=$v['id']?>')">
