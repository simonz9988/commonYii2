    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/balance/cash-record" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type">
                            ...
                            <?php foreach($type_list as $k=>$v):?>
                                <option value="<?=$k?>" <?=$searchArr && $searchArr['type']!= '' && $searchArr['type'] ==$k?'selected="selected"':''?>><?=$v?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
