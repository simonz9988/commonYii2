                    ...
                    <tbody>
                        <?php if($list):?>
                            ...
                            <tr>
                                ...
                                <td><?=$v['api_secret']?></td>
                                <td>
                                    <a class="btn btn-primary btn-xs" href="<?=url('/coin-user/edit?id='.$v['id'])?>"> <i class="ace-icon fa fa-edit bigger-100"></i> 修改</a>
                                    <a class="btn btn-xs btn-danger cus-btn-del" href="javascript:void(0);" onclick="delModel('/coin-user/del?id=<?=$v['id']?>')">
