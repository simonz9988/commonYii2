    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/lh-process/save" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="type" class="input-sm  col-xs-12 col-sm-6">
                            <option value="INPUT" <?=$info&&$info['type']=='INPUT'?'selected="selected"':''?>>输入框</option>
                            <option value="CALC"  <?=$info&&$info['type']=='CALC'?'selected="selected"':''?>>公式计算</option>
                        </select>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right">排序(越小排序越靠前)</label>
