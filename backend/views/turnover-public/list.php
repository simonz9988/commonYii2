...
<div class="breadcrumbs" id="breadcrumbs">
    <div class="row">
        ...
        <div class="col-md-4 text-right" >
            <a href="<?=url('/turnover-public/edit')?>" class="btn btn-primary btn-sm no-border J_checkauth" data-auth="/turnover-public/edit"><i class="ace-icon glyphicon glyphicon-plus"></i> 新增</a>
        </div>
    ...
    <div class="page-header">
        ...
        <div class="row">
            <div class="col-xs-12 page-search">
                <form class="form-inline" id="shippingOrderSearchForm" action="/turnover-public/index" method="get">
                    ...
                    <div class="form-group">
                        <label>款项：</label>
                        <select name="kuanxiang" class="input-sm  form-control">
                            <option value="">请选择</option>
                            <?php foreach($kuanxiang_list as $k=>$v):?>
                                <option value="<?=$v['id']?>" <?=$searchArr&&$searchArr['kuanxiang']==$v['id']?'selected="selected"':''?>><?=$v['detail']?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label>明细：</label>
                        <input name="mingxi" value="<?=$searchArr?$searchArr['mingxi']:''?>" class="input-sm  form-control" type="text">
                    </div>
                    ...
                    <div class="form-group">
                        <label>账户余额：</label>
                        <input name="balance" value="<?=$searchArr?$searchArr['balance']:''?>" class="input-sm  form-control" type="text">
                    </div>
                        ...
                        <?php if($list):?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary btn-xs J_checkauth" data-auth="/turnover-public/modify" href="<?=url('/turnover-public/modify?id='.$v['id'])?>"> <i class="ace-icon fa fa-edit bigger-100"></i> 修改</a>
                                    <a class="btn btn-primary btn-xs J_checkauth" data-auth="/turnover-public/view" href="<?=url('/turnover-public/view?id='.$v['id'])?>"> <i class="ace-icon fa fa-eye bigger-100"></i> 浏览</a>

                                    <a class="btn btn-xs btn-danger cus-btn-del J_checkauth" data-auth="/turnover-public/del" href="javascript:void(0);" onclick="delModel('/turnover-public/del?id=<?=$v['id']?>')">
