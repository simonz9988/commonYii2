...
<div class="page-content">
    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/system/do-add-role" method="post">

                <input type="hidden" name="id" value="<?=$info?$info['id']:0?>">

                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right"> 角色关键字</label>

                    <div class="col-sm-5">
                        <input value="<?=$info?$info['role_key']:''?>"name="role_key" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input value="<?=$info?$info['role_value']:''?>"name="role_value" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                        <label class="col-sm-12 form-control-static reg_tip">
                        </label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input value="<?=$info?$info['role_description']:''?>"name="role_description" class="col-xs-12 col-sm-6" type="text">
                    </div>
                    <div class="col-sm-4">
                        <label class="col-sm-12 form-control-static reg_tip">
                        </label>
