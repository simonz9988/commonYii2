...
<div class="page-content">
    ...
    <div class="row ">
        <div class="col-xs-12">
            <form novalidate="novalidate" class="form-horizontal" role="form" id="systeamAddMenu" action="/system/do-add-menu" method="post">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right">菜单分类</label>

                    <div class="col-sm-5">
                        <select name="menu_cate_id" class="input-sm  col-xs-12 col-sm-6">
                            <option value="0">请选择</option>
                            <?php foreach($allMenuCate as $v){?>
                                <option value="<?php echo $v['id']?>" <?php if($info && $info['menu_cate_id'] ==$v['id']){echo 'selected="selected"' ;}?> ><?php echo $v['name'];?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-sm-4">
