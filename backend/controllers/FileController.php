        ...
        if($a){
            ...
            if(!in_array($file_type,$allowed_file_type)){
                ...
                if($file_size>$max_size){
                    ...
                    $old_user_upload_file_name = $user_upload_file_name ;
                    ...
                    $old_user_upload_file_name .=".".$file_ext ;
                    if(createFolder($all_path)){
                        ...
                        $info = array('data' => $file_dir . $file_name, 'code' => '1', 'msg' => '上传成功', 'file_name' => $file_name,'file_path'=>$file_path,'user_upload_file_name'=>$old_user_upload_file_name);
