$(function(){
    ...
    init_pdf_uploader("pdf_upload","instructions_upload");
...
//所有产品说明选择商品模型
function showAllFilterGoodsModel(a){
  var init_model_id = $(a).attr("init_model_id");
  var init_model_img = $(a).attr("init_model_img");
  $.post(
    '/goods/ajaxShowGoodsModel',
    {init_model_id:init_model_id,init_model_img:init_model_img,is_help_filter:1,is_all:1},function(data){
