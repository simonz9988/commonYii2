$(function() {
    ...
    $("#systeamAddMenu").validate({
        rules: {
            ...
            amount: {required: true,min: cash_out_min_amount,max:cash_out_max_amount, minNumber:$("#input_amount").val() },
        ...
        messages: {
            ...
            amount: {required: "必填",min:"必须为大于等于"+cash_out_min_amount+"数字",max:"须为小于等于"+cash_out_max_amount+"数字"},
            bank_account: {required: "必填"},
            pay_time: {required: "必填"},
            bank_name: {required: "必填"},
            file_name: {required: "必填"},
            code: {required: "必填"},
    ...
    init_source_uploader('upload_file','cash_out')
}); 
