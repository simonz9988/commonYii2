...
<title>WebService接口PHP_Demo(短连接)-----【异步请求】单线程</title>
...
<body>
提交方式：<input type="radio" id="type1" name="type" value="0" checked="checked"/><label for="type1">Soap</label>
...
&nbsp;&nbsp;
<input type="checkbox" id="selfsend" name="selfsend" /><label for="selfsend">个性化发送</label>
