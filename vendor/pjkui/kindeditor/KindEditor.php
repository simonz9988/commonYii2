...
//            'uploadJson' => Url::to(['Kupload', 'action' => 'uploadJson']),
            'uploadJson' => Url::to("/file/do-kind-upload"),
            'width' => '100%',
            'height' => '400',
            'filterMode' => false,
    ...
    public function run() {
        ...
        if ($this->hasModel()) {
            ...
            switch ($this->editorType) {
                ...
                default:
                    return Html::textarea($this->name?$this->name:$this->id, $this->value, ['id' => $this->id]);
                    break;
            }
        }
    }
...
EOT;
                ...
                break;
            default:
                $script = "var KindEditorInstance_" . $this->id . " = null;KindEditor.ready(function(K) {KindEditorInstance_" . $this->id . " = K.create('#" . $this->id . "', " . $clientOptions . ");});";
                break;
        }
